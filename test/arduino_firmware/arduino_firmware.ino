...
/**************************** DATA TYPES ****************************/
typedef byte BYTE;             // 8-bit byte
typedef u32  WORD;             // 32-bit word, change to "long" for 16-bit machines
...
void sha256_init(SHA256_CTX *ctx,BYTE in_partial_digest[])
{
  ctx->datalen = 0;
  ctx->bitlen = 0;
